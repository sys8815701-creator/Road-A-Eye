        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                padding: '5px 14px', borderRadius: 20, fontSize: 14, fontWeight: 800, marginBottom: 14,
              }}>조사 배경 및 목적</div>
              <p style={{ fontSize: 19, color: '#46586a', lineHeight: 1.8, margin: 0 }}>
                고속도로에서 반복적으로 발생하는 vehicle 사고를 예방하고,
                실시간 신속하게 대응하는{' '}
            ...
            <div style={{
              ...
              <p style={{ fontSize: 19, color: '#46586a', lineHeight: 1.8, margin: 0 }}>
                프로젝트를 통해{' '}
                <span className={styles.highlightBlue}>고속도로 vehicle 사고 방지</span> 및
                사고 발생시 신속한 대응으로{' '}
          ...
          <div style={{
            ...
            <div style={{
              ...
              <img src="/members/MBC 오토바이.png" alt="MBC 오토바이" style={{ width: '100%', height: 360, objectFit: 'cover', display: 'block' }} />
            </div>
            <p style={{
