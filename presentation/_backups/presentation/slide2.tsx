      ...
      <div className={styles.content}>
        ...
        <div className={styles.gridThree} style={{ width: '100%' }}>
          {[
            ...
            <div key={item.num} style={{ borderTop: '2px solid #333', paddingTop: 16, textAlign: 'center' }}>
              <div style={{ fontSize: 16, fontWeight: 600, color: '#888', marginBottom: 8 }}>{item.num}</div>
