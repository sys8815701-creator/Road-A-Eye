        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 20, color: '#1f2d3d', lineHeight: 1.9, margin: 0, fontWeight: 600 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <img src="/members/MBC 오토바이.png" alt="MBC 오토바이" style={{ width: '100%', height: 'auto', display: 'block' }} />
            </div>
            <p style={{
